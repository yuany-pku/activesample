function [x,f,funEvals] = minConF_TMP(funObj,x,LB,UB,options,varargin)
...
while funEvals <= maxIter
    ...
    if secondOrder
        [f_new,g_new,H] = funObj(x_new, varargin{:});
    else
        [f_new,g_new] = funObj(x_new,varargin{:});
    end
    funEvals = funEvals+1;
    ...
    if secondOrder && lineSearchIters > 1
        [f_new,g_new,H] = funObj(x,varargin{:});
    end
