...
for time=1:run_time
    ...
    for num=1:totalnum
        ...
        edges_add=[edges_add
            edge(maxgain_index,:)];
        confusing_level=[confusing_level
            abs(s_bar(edge(maxgain_index,1))-s_bar(edge(maxgain_index,2)))]; %model 1
